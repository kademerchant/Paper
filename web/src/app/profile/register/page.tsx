...
export default function Register(): ReactElement {
  ...
  return (
    <>
      <div className="flex flex-row pt-1 whitespace-nowrap overflow-x-auto w-full animate-loop-scroll space-x-4">
        {[...Array(14)].map((_, index) => (
          <h1 key={index} className="text-2xl font-quest-italic">
            Register
          </h1>
        ))}
      </div>
      <main className="flex flex-col items-center justify-center w-4/5 sm:w-6/7 mx-auto min-h-full">
        <div className="sm:w-full md:w-4/6 lg:w-4/6 mb-40">
          ...
          >
            ...
            <input
              className="w-full pt-1 font-quest outline-black outline-1"
              type="text"
